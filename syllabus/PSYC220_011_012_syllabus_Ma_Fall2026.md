...
If you are having trouble with this course or its material, you should contact me via email (<feilong@sc.edu>) to discuss the issues.
...
**B+: 86-89%** (430-449.5 points)

**B: 80-85%** (400-429.5 points)

**C+: 76-79%** (380-399.5 points)

**C: 70-75%** (350-379.5 points)

**D+: 65-69%** (325-349.5 points)

**D: 60-64%** (300-324.5 points)
...
Using generative AI (GenAI) tools—and learning when and how to use them effectively—is an important skill for learning and productivity. You are encouraged to use GenAI tools in this course, with strict restrictions:

**Permitted Uses**

You may use GenAI tools in certain activities to support your progress toward the Learning Outcomes of the course, including:

- Generate study notes or summaries for personal use.

- Discuss class materials to help you understand them.

- Explain the concepts that you do not understand.

- Show you how to calculate statistics manually.
